...
class FolderScanner {
	...
	function __construct(Connection $connectionARG, Output $outputARG, $lastUpdateDateARG, PageDownloader $pageDownloaderARG) {
		$this->connection = $connectionARG;
		$this->lastUpdateDate = $lastUpdateDateARG;
